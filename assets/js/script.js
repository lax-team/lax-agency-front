;(function ($) {
  ...
  const sticky_id = $('.transparent-header')
  ...
  $('.project-2').imagesLoaded(function () {
    // init Isotope
    const $grid = $('.aportfolio-active').isotope({
  ...
  if (jQuery('.slider-active').length > 0) {
    const sliderActive1 = '.slider-active'
  ...
  if (jQuery('.testimonial-active').length > 0) {
    const swipertestimonial = new Swiper('.testimonial-active', {
      slidesPerView: 1,
      spaceBetween: 30,
      // direction: 'vertical',
      loop: true,
  ...
  if (jQuery('.project-active').length > 0) {
    const swiperproject = new Swiper('.project-active', {
      slidesPerView: 1,
      spaceBetween: 30,
      // direction: 'vertical',
      loop: true,
  ...
  if (jQuery('.blog-active').length > 0) {
    const swiperblog = new Swiper('.blog-active', {
      slidesPerView: 1,
      spaceBetween: 30,
      // direction: 'vertical',
      loop: false,
  ...
  if (jQuery('.team-active').length > 0) {
    const swiperteam = new Swiper('.team-active', {
      slidesPerView: 1,
      spaceBetween: 30,
      // direction: 'vertical',
      loop: false,
  ...
  if (jQuery('.team-active2').length > 0) {
    const swiperteam2 = new Swiper('.team-active2', {
      slidesPerView: 1,
      spaceBetween: 30,
      // direction: 'vertical',
      loop: false,
