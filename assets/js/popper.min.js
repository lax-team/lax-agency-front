 ...
 */ ;(function (e, t) {
  ...
  function q(e, t) {
    const o = e.offsets;
      ...
      const s = r(i.width);
      const d = r(n.width);
      const a = ['left', 'right'].includes(e.placement);
      const l = e.placement.includes('-');
  ...
  for (
    ...
    if (te && navigator.userAgent.includes(oe[ie])) {
      ne = 1
      break
    }
          ...
          fn (e, t) {
            ...
            return (
              l.forEach(function (e) {
                const t =
                  !['left', 'top'].includes(e) ? 'secondary' : 'primary'
                f = fe({}, f, m[t](e))
              }),
              (e.offsets.popper = f),
              e
