            ...
            <div class="section-title-wrapper mb-4">
              <div class="d-flex justify-content-center show-background">
                <img
                  ...
                  src="https://storage.googleapis.com/imageslit/LAX/Lax_Agency/WEBINAR_FIN_ANO/Promocional_Visual%20Landing.png"
              ...
              <div class="d-flex justify-content-center">
                <span class="my-3 title">
                  <strong
                    style="color: #f5369e !important"
                    class="
                      font-family-MonumentExtended-Regular
                      text-responsive-title
                    "
                    >REGISTRATE SIN COSTO PARA PARTICIPAR.</strong
                  >
                  ...
                  >
                    Deja tus datos completos en el formulario y te enviaremos un
                    correo con el link de acceso al webinar.
                  </p>
                  ...
                  <p
                    ...
                    "
                    class="text--primary--lax"
                  >
                    FECHA:
                    <strong> Martes, 06 de diciembre</strong>
                  </p>
                  ...
                  >
                    HORA:
                    <strong> 8:30 am (Hora colombia)</strong>
                  </p>
                </span>
              </div>
            </div>
  ...
  methods: {
    ...
    async sendDataContact() {
      try {
        ...
        this.dataContact.pageType =
          'webinar-7-consejos-para-iniciar-bien-el-ano'
...
.theme-btn {
  background-color: #f5369e !important;
  width: 20rem;
}
