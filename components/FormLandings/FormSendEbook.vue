            ...
            <div class="section-title-wrapper">
              <div class="d-flex justify-content-center">
                <span class="mt-1 title">
                  Deja tus datos completos en el formulario para <br />
                  <strong class="text-white">DESCARGAR GRATIS</strong> nuestro
                  E-book
                </span>
              </div>
              <h2
                class="text-center title-2 font-family-MonumentExtended-Black"
              >
                “COMUNICA COMO UN ROCKSTAR”
              </h2>
            </div>
            <div class="row">
              ...
              <div class="col-12 mt-2">
                <form>
                  ...
                  <div class="mb-3 mt-2 form-check">
                    <p style="font-size: 15px">*Campos obligatorios</p>
                    ...
                    <label for="checkbox">
                      ...
                      >
                        términos y condiciones de la política de
                        datos.</NuxtLink
                      >
                    </label>
                  </div>
                  <div class="d-flex justify-content-center">
                    ...
                    >
                      ...
                      <span v-else> ENVIAR Y DESCARGAR </span>
                    </button>
                  </div>
                </form>
              </div>
  ...
  methods: {
    ...
    async sendDataContact() {
      try {
        ...
        this.dataContact.pageType = 'descarga-ebook-sms'
